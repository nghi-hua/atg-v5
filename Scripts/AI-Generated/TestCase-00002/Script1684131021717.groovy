...
'step 1: Login at https://nguyen-tri-nhan.github.io/ --> navigate to Page_inventory-item_html'
...
'step 2: Navigate to Page_inventory-item_html'

WebUI.navigateToUrl(GlobalVariable.application_domain + '')

'step 3: Add visual checkpoint at Page_inventory-item_html'
